...
class Campaign extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['cmpg_judul', 'cmpg_deskripsi', 'cmpg_cerita', 'cmpg_targetdana', 'cmpg_durasihari', 'cmpg_totaldana', 'cmpg_laba_inv', 'cmpg_laba_pd', 'cmpg_kota', 'cmpg_kategori_id', 'cmpg_kategori', 'cmpg_resiko', 'user_id'], 'required'],
            [['cmpg_cerita', 'cmpg_poster', 'cmpg_resiko'], 'string'],
            [['cmpg_targetdana', 'cmpg_totaldana'], 'number'],
            [['cmpg_durasihari', 'cmpg_laba_inv', 'cmpg_laba_pd', 'cmpg_kategori_id', 'user_id', 'cmpg_status'], 'integer'],
